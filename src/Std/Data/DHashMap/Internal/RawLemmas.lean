...
private theorem _root_.List.Perm.congr_left
    {α : Type u} {l₁ l₂ l₃ : List α} (h : l₁.Perm l₂) : l₁.Perm l₃ ↔ l₂.Perm l₃ :=
  ⟨h.symm.trans, h.trans⟩

private theorem _root_.List.Perm.congr_right
    {α : Type u} {l₁ l₂ l₃ : List α} (h : l₂.Perm l₃) : l₁.Perm l₂ ↔ l₁.Perm l₃ :=
...
private def congrNames : MacroM (Array (TSyntax `term)) := do
  return #[← `(_root_.List.Perm.isEmpty_eq), ← `(containsKey_of_perm),
    ...
    ← `(getKey!_of_perm _), ← `(_root_.List.Perm.congr_left), ← `(_root_.List.Perm.congr_right)]
...
theorem get_insert [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {k a : α} {v : β} {h₁} :
  ...
  simp_to_model [Const.get, insert] using List.getValue_insertEntry

theorem get_insert_self [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {k : α} {v : β} :
    get (m.insert k v) k (contains_insert_self _ h) = v := by
  simp_to_model [Const.get, insert] using List.getValue_insertEntry_self
...
theorem get_erase [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {k a : α} {h'} :
  ...
  simp_to_model [Const.get, erase] using List.getValue_eraseKey
...
theorem get_eq_get [LawfulBEq α] (h : m.1.WF) {a : α} {h} : get m a h = m.get a h := by
  simp_to_model [get, Const.get] using List.getValue_eq_getValueCast
...
theorem getKey?_insert [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {a k : α} {v : β k} :
  ...
  simp_to_model [getKey?, insert] using List.getKey?_insertEntry

theorem getKey?_insert_self [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {k : α} {v : β k} :
    (m.insert k v).getKey? k = some k := by
  simp_to_model [getKey?, insert] using List.getKey?_insertEntry_self
...
theorem getKey?_erase [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {k a : α} :
  ...
  simp_to_model [getKey?, erase] using List.getKey?_eraseKey

theorem getKey?_erase_self [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {k : α} :
    (m.erase k).getKey? k = none := by
  simp_to_model [getKey?, erase] using List.getKey?_eraseKey_self
...
theorem getKey_insert [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {k a : α} {v : β k} {h₁} :
  ...
  simp_to_model [getKey, insert] using List.getKey_insertEntry
...
theorem getKey_insert_self [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {k : α} {v : β k} :
  ...
  simp_to_model [getKey, insert] using List.getKey_insertEntry_self
...
theorem getKey_erase [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {k a : α} {h'} :
  ...
  simp_to_model [getKey, erase] using List.getKey_eraseKey
...
theorem getKey!_eq_default [EquivBEq α] [LawfulHashable α] [Inhabited α] (h : m.1.WF) {a : α} :
  ...
  simp_to_model [getKey!, contains] using List.getKey!_eq_default
...
theorem getKey?_eq_some_getKey! [EquivBEq α] [LawfulHashable α] [Inhabited α] (h : m.1.WF) {a : α} :
  ...
  simp_to_model [getKey?, contains, getKey!] using List.getKey?_eq_some_getKey!
...
theorem getKeyD_of_isEmpty [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {a fallback : α} :
  ...
  simp_to_model [getKeyD, isEmpty]; empty
...
theorem getKeyD_insert [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {k a fallback : α} {v : β k} :
  ...
  simp_to_model [getKeyD, insert] using List.getKeyD_insertEntry

theorem getKeyD_insert_self [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {a fallback : α}
    {b : β a} :
    (m.insert a b).getKeyD a fallback = a := by
  simp_to_model [getKeyD, insert] using List.getKeyD_insertEntry_self
...
theorem getKeyD_eq_fallback [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {a fallback : α} :
  ...
  simp_to_model [getKeyD, contains] using List.getKeyD_eq_fallback
...
theorem getKey?_eq_some_getKeyD [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {a fallback : α} :
  ...
  simp_to_model [getKeyD, getKey?, contains] using List.getKey?_eq_some_getKeyD
...
theorem contains_insertIfNew [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {k a : α} {v : β k} :
  ...
  simp_to_model [contains, insertIfNew] using List.containsKey_insertEntryIfNew

theorem contains_insertIfNew_self [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {k : α} {v : β k} :
    (m.insertIfNew k v).contains k := by
  simp_to_model [contains, insertIfNew] using List.containsKey_insertEntryIfNew_self
...
theorem contains_of_contains_insertIfNew [EquivBEq α] [LawfulHashable α] (h : m.1.WF) {k a : α}
  ...
  simp_to_model [contains, insertIfNew] using List.containsKey_of_containsKey_insertEntryIfNew
...
theorem get?_insertIfNew [LawfulBEq α] (h : m.1.WF) {k a : α} {v : β k} :
  ...
  simp_to_model [get?, contains, insertIfNew] using List.getValueCast?_insertEntryIfNew
...
theorem get_insertIfNew [LawfulBEq α] (h : m.1.WF) {k a : α} {v : β k} {h₁} :
  ...
  simp_to_model [get, contains, insertIfNew] using List.getValueCast_insertEntryIfNew
...
theorem getD_insertIfNew [LawfulBEq α] (h : m.1.WF) {k a : α} {fallback : β a} {v : β k} :
  ...
  simp_to_model [getD, contains, insertIfNew] using List.getValueCastD_insertEntryIfNew
...
theorem get?_of_equiv [LawfulBEq α] (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k : α} : m₁.get? k = m₂.get? k := by
  simp_to_model [get?] using getValueCast?_of_perm _ h.perm_toListModel

theorem get_of_equiv [LawfulBEq α] (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k : α} (h₁' : m₁.contains k) (h₂' : m₂.contains k) :
    m₁.get k h₁' = m₂.get k h₂' := by
  simp_to_model [get] using getValueCast_of_perm _ h.perm_toListModel

theorem get!_of_equiv [LawfulBEq α] (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k : α} [Inhabited (β k)] : m₁.get! k = m₂.get! k := by
  simp_to_model [get!] using getValueCast!_of_perm _ h.perm_toListModel

theorem getD_of_equiv [LawfulBEq α] (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k : α} {fallback : β k} : m₁.getD k fallback = m₂.getD k fallback := by
  simp_to_model [getD] using getValueCastD_of_perm _ h.perm_toListModel

theorem getKey?_of_equiv [EquivBEq α] [LawfulHashable α]
    (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k : α} : m₁.getKey? k = m₂.getKey? k := by
  simp_to_model [getKey?] using getKey?_of_perm _ h.perm_toListModel

theorem getKey_of_equiv [EquivBEq α] [LawfulHashable α]
    (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k : α} (h₁' : m₁.contains k) (h₂' : m₂.contains k) :
    m₁.getKey k h₁' = m₂.getKey k h₂' := by
  simp_to_model [getKey] using getKey_of_perm _ h.perm_toListModel

theorem getKey!_of_equiv [EquivBEq α] [LawfulHashable α] [Inhabited α]
    (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k : α} : m₁.getKey! k = m₂.getKey! k := by
  simp_to_model [getKey!] using getKey!_of_perm _ h.perm_toListModel

theorem getKeyD_of_equiv [EquivBEq α] [LawfulHashable α]
    (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k fallback : α} : m₁.getKeyD k fallback = m₂.getKeyD k fallback := by
  simp_to_model [getKeyD] using getKeyD_of_perm _ h.perm_toListModel

theorem insert_equiv_congr [EquivBEq α] [LawfulHashable α]
    (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k : α} {v : β k} : Raw.Equiv (m₁.insert k v).1 (m₂.insert k v).1 := by
  simp_to_model [insert, Equiv] using insertEntry_of_perm _ h.perm_toListModel

theorem erase_equiv_congr [EquivBEq α] [LawfulHashable α]
    (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k : α} : Raw.Equiv (m₁.erase k).1 (m₂.erase k).1 := by
  simp_to_model [erase, Equiv] using eraseKey_of_perm _ h.perm_toListModel

namespace Const

variable {β : Type v} {m₁ m₂ : Raw₀ α fun _ => β} [EquivBEq α] [LawfulHashable α]

theorem get?_of_equiv (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k : α} : Const.get? m₁ k = Const.get? m₂ k := by
  simp_to_model [Const.get?] using getValue?_of_perm _ h.perm_toListModel

theorem get_of_equiv (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k : α} (h₁' : m₁.contains k) (h₂' : m₂.contains k) :
    Const.get m₁ k h₁' = Const.get m₂ k h₂' := by
  simp_to_model [Const.get] using getValue_of_perm _ h.perm_toListModel

theorem get!_of_equiv (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k : α} [Inhabited β] : Const.get! m₁ k = Const.get! m₂ k := by
  simp_to_model [Const.get!] using getValue!_of_perm _ h.perm_toListModel

theorem getD_of_equiv (h₁ : m₁.1.WF) (h₂ : m₂.1.WF) (h : Raw.Equiv m₁.1 m₂.1)
    {k : α} {fallback : β} : Const.getD m₁ k fallback = Const.getD m₂ k fallback := by
  simp_to_model [Const.getD] using getValueD_of_perm _ h.perm_toListModel
