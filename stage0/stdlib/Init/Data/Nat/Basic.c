...
lean_mark_persistent(l_Nat_instTransLt);
l_Nat_instTransLe = _init_l_Nat_instTransLe();
lean_mark_persistent(l_Nat_instTransLe);
l_Nat_instTransLtLe = _init_l_Nat_instTransLtLe();
lean_mark_persistent(l_Nat_instTransLtLe);
l_Nat_instTransLeLt = _init_l_Nat_instTransLeLt();
lean_mark_persistent(l_Nat_instTransLeLt);
