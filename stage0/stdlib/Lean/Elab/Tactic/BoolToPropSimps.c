...
x_2 = lean_mk_string_unchecked("bool_to_prop", 12, 12);
x_3 = l_Lean_Name_mkStr1(x_2);
x_4 = lean_mk_string_unchecked("simp lemmas converting boolean expressions in terms of `decide` into propositional statements", 93, 93);
lean_inc(x_3);
x_5 = l_Lean_Meta_registerSimpAttr(x_3, x_4, x_3, x_1);
return x_5;
}
}
...
{
lean_object* x_2; lean_object* x_3; lean_object* x_4; lean_object* x_5; 
x_2 = lean_mk_string_unchecked("boolToPropSimps", 15, 15);
x_3 = l_Lean_Name_mkStr1(x_2);
x_4 = lean_mk_string_unchecked("simp lemmas converting boolean expressions in terms of `decide` into propositional statements", 93, 93);
lean_inc(x_3);
x_5 = l_Lean_Meta_registerSimpAttr(x_3, x_4, x_3, x_1);
