...
x_8 = lean_mk_string_unchecked("error, plugin has invalid file name '", 37, 37);
...
x_19 = lean_mk_string_unchecked("lib", 3, 3);
x_20 = l_String_stripPrefix(x_14, x_19);
x_21 = lean_mk_string_unchecked("_shared", 7, 7);
x_22 = l_String_stripSuffix(x_20, x_21);
x_23 = lean_mk_string_unchecked("initialize_", 11, 11);
...
lean_dec(x_17);
x_26 = lean_mk_string_unchecked("error loading plugin, initializer not found '", 45, 45);
...
lean_inc(x_34);
lean_dec(x_15);
x_36 = lean_mk_string_unchecked("lib", 3, 3);
x_37 = l_String_stripPrefix(x_14, x_36);
x_38 = lean_mk_string_unchecked("_shared", 7, 7);
x_39 = l_String_stripSuffix(x_37, x_38);
x_40 = lean_mk_string_unchecked("initialize_", 11, 11);
...
lean_dec(x_34);
x_43 = lean_mk_string_unchecked("error loading plugin, initializer not found '", 45, 45);
...
x_61 = lean_mk_string_unchecked("lib", 3, 3);
x_62 = l_String_stripPrefix(x_56, x_61);
x_63 = lean_mk_string_unchecked("_shared", 7, 7);
x_64 = l_String_stripSuffix(x_62, x_63);
x_65 = lean_mk_string_unchecked("initialize_", 11, 11);
...
lean_dec(x_58);
x_68 = lean_mk_string_unchecked("error loading plugin, initializer not found '", 45, 45);
...
x_85 = lean_mk_string_unchecked("error, plugin has invalid file name '", 37, 37);
...
x_97 = lean_mk_string_unchecked("lib", 3, 3);
x_98 = l_String_stripPrefix(x_91, x_97);
x_99 = lean_mk_string_unchecked("_shared", 7, 7);
x_100 = l_String_stripSuffix(x_98, x_99);
x_101 = lean_mk_string_unchecked("initialize_", 11, 11);
...
lean_dec(x_94);
x_104 = lean_mk_string_unchecked("error loading plugin, initializer not found '", 45, 45);
