...
x_3 = lean_mk_string_unchecked("match_pattern", 13, 13);
x_4 = l_Lean_Name_mkStr1(x_3);
x_5 = lean_mk_string_unchecked("mark that a definition can be used in a pattern (remark: the dependent pattern matching compiler will unfold the definition)", 124, 124);
x_6 = lean_mk_string_unchecked("Lean", 4, 4);
x_7 = lean_mk_string_unchecked("matchPatternAttr", 16, 16);
