...
lean_inc(x_5);
lean_dec(x_3);
x_6 = lean_mk_string_unchecked("LEAN_SYSROOT", 12, 12);
...
x_13 = lean_mk_string_unchecked("lake", 4, 4);
...
lean_inc(x_22);
lean_dec(x_8);
x_23 = lean_mk_string_unchecked("bin", 3, 3);
...
lean_inc(x_28);
lean_dec(x_8);
x_29 = lean_mk_string_unchecked("bin", 3, 3);
