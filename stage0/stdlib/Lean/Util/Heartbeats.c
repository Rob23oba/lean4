...
lean_inc(x_4);
x_5 = lean_alloc_closure((void*)(l_IO_getNumHeartbeats___boxed), 1, 0);
...
lean_dec(x_15);
x_17 = lean_mk_string_unchecked("` stopped because it was running out of time.\nYou may get better results using `set_option maxHeartbeats 0`.", 108, 108);
...
lean_dec(x_29);
x_31 = lean_mk_string_unchecked("` stopped because it was running out of time.\nYou may get better results using `set_option maxHeartbeats 0`.", 108, 108);
