...
static const lean_string_object l_Lean_IR_toIRType___closed__3_value = {.m_header = {.m_rc = 0, .m_cs_sz = 0, .m_other = 0, .m_tag = 249}, .m_size = 15, .m_capacity = 15, .m_length = 14, .m_data = "borrowedReturn"};
static const lean_object* l_Lean_IR_toIRType___closed__3 = (const lean_object*)&l_Lean_IR_toIRType___closed__3_value;
...
v___x_68_ = lean_unsigned_to_nat(50u);
...
LEAN_EXPORT lean_object* l_Lean_IR_toIRType(lean_object* v_type_74_){
_start:
{
switch(lean_obj_tag(v_type_74_))
{
case 4:
{
lean_object* v_declName_78_; 
v_declName_78_ = lean_ctor_get(v_type_74_, 0);
if (lean_obj_tag(v_declName_78_) == 1)
{
lean_object* v_pre_79_; 
v_pre_79_ = lean_ctor_get(v_declName_78_, 0);
if (lean_obj_tag(v_pre_79_) == 0)
{
lean_object* v_us_80_; lean_object* v_str_81_; lean_object* v___x_82_; uint8_t v___x_83_; 
v_us_80_ = lean_ctor_get(v_type_74_, 1);
v_str_81_ = lean_ctor_get(v_declName_78_, 1);
v___x_82_ = ((lean_object*)(l_Lean_IR_nameToIRType___closed__4));
v___x_83_ = lean_string_dec_eq(v_str_81_, v___x_82_);
if (v___x_83_ == 0)
{
lean_object* v___x_84_; uint8_t v___x_85_; 
v___x_84_ = ((lean_object*)(l_Lean_IR_nameToIRType___closed__5));
v___x_85_ = lean_string_dec_eq(v_str_81_, v___x_84_);
if (v___x_85_ == 0)
{
lean_object* v___x_86_; uint8_t v___x_87_; 
v___x_86_ = ((lean_object*)(l_Lean_IR_nameToIRType___closed__6));
v___x_87_ = lean_string_dec_eq(v_str_81_, v___x_86_);
if (v___x_87_ == 0)
{
lean_object* v___x_88_; uint8_t v___x_89_; 
v___x_88_ = ((lean_object*)(l_Lean_IR_nameToIRType___closed__7));
v___x_89_ = lean_string_dec_eq(v_str_81_, v___x_88_);
if (v___x_89_ == 0)
{
lean_object* v___x_90_; uint8_t v___x_91_; 
v___x_90_ = ((lean_object*)(l_Lean_IR_nameToIRType___closed__8));
v___x_91_ = lean_string_dec_eq(v_str_81_, v___x_90_);
if (v___x_91_ == 0)
{
lean_object* v___x_92_; uint8_t v___x_93_; 
v___x_92_ = ((lean_object*)(l_Lean_IR_nameToIRType___closed__9));
v___x_93_ = lean_string_dec_eq(v_str_81_, v___x_92_);
if (v___x_93_ == 0)
{
lean_object* v___x_94_; uint8_t v___x_95_; 
v___x_94_ = ((lean_object*)(l_Lean_IR_toIRType___closed__2));
v___x_95_ = lean_string_dec_eq(v_str_81_, v___x_94_);
if (v___x_95_ == 0)
{
lean_object* v___x_96_; uint8_t v___x_97_; 
v___x_96_ = ((lean_object*)(l_Lean_IR_nameToIRType___closed__10));
v___x_97_ = lean_string_dec_eq(v_str_81_, v___x_96_);
if (v___x_97_ == 0)
{
lean_object* v___x_98_; uint8_t v___x_99_; 
v___x_98_ = ((lean_object*)(l_Lean_IR_nameToIRType___closed__11));
v___x_99_ = lean_string_dec_eq(v_str_81_, v___x_98_);
if (v___x_99_ == 0)
{
lean_object* v___x_100_; uint8_t v___x_101_; 
v___x_100_ = ((lean_object*)(l_Lean_IR_nameToIRType___closed__12));
v___x_101_ = lean_string_dec_eq(v_str_81_, v___x_100_);
if (v___x_101_ == 0)
{
lean_object* v___x_102_; uint8_t v___x_103_; 
v___x_102_ = ((lean_object*)(l_Lean_IR_nameToIRType___closed__13));
v___x_103_ = lean_string_dec_eq(v_str_81_, v___x_102_);
if (v___x_103_ == 0)
{
lean_object* v___x_104_; uint8_t v___x_105_; 
v___x_104_ = ((lean_object*)(l_Lean_IR_nameToIRType___closed__14));
v___x_105_ = lean_string_dec_eq(v_str_81_, v___x_104_);
if (v___x_105_ == 0)
{
goto v___jp_75_;
}
...
{
if (lean_obj_tag(v_us_80_) == 0)
{
lean_object* v___x_106_; 
v___x_106_ = lean_box(13);
return v___x_106_;
}
else
{
...
v_data_118_ = lean_ctor_get(v_type_74_, 0);
if (lean_obj_tag(v_data_118_) == 1)
{
lean_object* v_head_119_; lean_object* v_fst_120_; 
v_head_119_ = lean_ctor_get(v_data_118_, 0);
v_fst_120_ = lean_ctor_get(v_head_119_, 0);
if (lean_obj_tag(v_fst_120_) == 1)
{
lean_object* v_pre_121_; 
v_pre_121_ = lean_ctor_get(v_fst_120_, 0);
if (lean_obj_tag(v_pre_121_) == 0)
{
lean_object* v_expr_122_; lean_object* v_tail_123_; lean_object* v_snd_124_; lean_object* v_str_125_; lean_object* v___x_126_; uint8_t v___x_127_; 
v_expr_122_ = lean_ctor_get(v_type_74_, 1);
v_tail_123_ = lean_ctor_get(v_data_118_, 1);
v_snd_124_ = lean_ctor_get(v_head_119_, 1);
v_str_125_ = lean_ctor_get(v_fst_120_, 1);
v___x_126_ = ((lean_object*)(l_Lean_IR_toIRType___closed__3));
...
{
if (lean_obj_tag(v_snd_124_) == 3)
{
if (lean_obj_tag(v_tail_123_) == 0)
{
v_type_74_ = v_expr_122_;
goto _start;
}
else
{
...
v___x_76_ = lean_obj_once(&l_Lean_IR_toIRType___closed__1, &l_Lean_IR_toIRType___closed__1_once, _init_l_Lean_IR_toIRType___closed__1);
v___x_77_ = l_panic___at___00Lean_IR_nameToIRType_spec__0(v___x_76_);
return v___x_77_;
}
}
}
LEAN_EXPORT lean_object* l_Lean_IR_toIRType___boxed(lean_object* v_type_129_){
_start:
{
lean_object* v_res_130_; 
v_res_130_ = l_Lean_IR_toIRType(v_type_129_);
lean_dec_ref(v_type_129_);
return v_res_130_;
}
}
