...
uint8_t l_Std_Sat_CNF_instDecidableExistsMemOfDecidableEq(lean_object*, lean_object*, lean_object*);
...
x_4 = l_List_filterMapTR_go___at___Std_Sat_CNF_maxLiteral_spec__0(x_1, x_3);
x_5 = l_List_max_x3f___at___Std_Sat_CNF_Clause_maxLiteral_spec__1(x_4);
lean_dec(x_4);
return x_5;
}
}
...
lean_inc(x_1);
x_3 = l_Std_Sat_CNF_instDecidableExistsMemOfDecidableEq(lean_box(0), x_1, x_2);
lean_dec(x_2);
if (x_3 == 0)
{
lean_object* x_4; lean_object* x_5; lean_object* x_6; 
...
lean_dec(x_1);
x_5 = lean_box(0);
x_6 = l_List_replicateTR(lean_box(0), x_4, x_5);
return x_6;
}
else
{
...
lean_inc(x_1);
x_7 = l_Std_Sat_CNF_numLiterals(x_1);
x_8 = lean_alloc_closure((void*)(l_Std_Sat_CNF_relabelFin___lam__0___boxed), 2, 1);
lean_closure_set(x_8, 0, x_7);
x_9 = l_Std_Sat_CNF_relabel___redArg(x_8, x_1);
return x_9;
}
}
}
