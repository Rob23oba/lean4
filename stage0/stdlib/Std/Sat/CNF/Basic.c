...
uint8_t l_List_decidableBEx(lean_object*, lean_object*, lean_object*, lean_object*);
...
x_4 = lean_box(1);
x_5 = l_instBEqOfDecidableEq___redArg(x_3);
x_6 = lean_alloc_closure((void*)(l_instDecidableEqBool___boxed), 2, 0);
x_7 = l_instBEqOfDecidableEq___redArg(x_6);
x_8 = l_instBEqProd___redArg(x_5, x_7);
x_9 = lean_box(0);
lean_inc(x_1);
...
lean_inc(x_2);
lean_inc(x_8);
x_11 = l_List_instDecidableMemOfLawfulBEq(lean_box(0), x_8, lean_box(0), x_10, x_2);
if (x_11 == 0)
{
...
x_13 = l_List_instDecidableMemOfLawfulBEq(lean_box(0), x_8, lean_box(0), x_12, x_2);
if (x_13 == 0)
{
return x_13;
}
...
x_5 = l_List_decidableBEx(lean_box(0), lean_box(0), x_4, x_2);
return x_5;
}
}
